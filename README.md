...
3. Escull 4 números i clica **EXECUTAR CODI**.
4. Tens **5 intents** per endevinar el codi secret.

### Símbols de pista
| Símbol | Significat |
|---|---|
| `1` | Número correcte i en la posició correcta |
| `Ø` | Número correcte però en posició incorrecta |
| `×` | El número no existeix en el codi secret |
...
| | Git | Tradicional |
|---|---|---|
| Historial | Complet | No existeix |
| Col·laboració | Integrada | Manual |
| Reversibilitat | Sí | No |
| Treball en paral·lel | Amb branques | Molt difícil |
...
```bash
git checkout -b feature-ui-logic
```
...
| | Públic | Privat |
|---|---|---|
| Qui el veu | Tothom | Només col·laboradors |
| Ús habitual | Open source, portfolis | Projectes d'empresa |
| Cost | Gratuït | Gratuït amb límits |

---

**P13 — Com afegir un col·laborador:**

1. Anar al repositori → **Settings**.
2. Clicar **Collaborators**.
3. Clicar **Add people** i cercar l'usuari.
4. L'usuari accepta la invitació.
...
1. Un membre crea el repositori i afegeix col·laboradors.
2. Cadascú **clona** el repositori.
3. Cada persona crea una **branca** pròpia.
4. Fan `commits` amb els seus canvis.
5. Pugen la branca amb `git push`.
6. Obren una **pull request**.
7. L'equip revisa i fa el **merge** a `main`.
